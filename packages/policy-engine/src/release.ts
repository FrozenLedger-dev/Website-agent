/**
 * Release policy — whether a validated revision may be published.
 *
 * Pure. Sol recommends; this decides. Keeping them apart is the point: the
 * manifest used to record `approvedBy: "sol:machine-approval"` for a decision
 * no model was consulted about, which credited the model for the harness's own
 * arithmetic and left nothing to check the harness against.
 *
